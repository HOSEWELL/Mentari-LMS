...
<head>
    ...
    <style>
        ...
        .welcome-card { background: white; padding: 20px; border-radius: 12px; box-shadow: 0 4px 6px rgba(0,0,0,0.1); }
        @media (max-width: 768px) {
            .sidebar { display: none; } /* Hide sidebar on mobile or use a hamburger menu */
            ...
            <div class="welcome-card">
                ...
                <div class="stats-grid" style="display: flex; gap: 20px; flex-wrap: wrap;">
                    <div style="flex: 1; min-width: 200px; background: #e3f2fd; padding: 15px; border-radius: 8px;">
                        ...
                        <a href="my-courses" class="btn">View Courses</a>
                    </div>
                    <div style="flex: 1; min-width: 200px; background: #fff3e0; padding: 15px; border-radius: 8px;">
                        <h4>Referrals</h4>
                        <p>Need a referral? Submit a request here.</p>
                        <a href="request-deferral" class="btn">Request Now</a>
                    </div>
                </div>
            </div>
        </main>
